<?php
  ...
  $preference->back_urls = array(
    "success" => "http://sistemasyahualica.ddns.net:8080/sistema/venta_boletos/venta_boletos.php?referencia=$referencia",
    "failure" => "http://sistemasyahualica.ddns.net:8080/sistema/venta_boletos/redireccion.php",
    "pending" => "http://sistemasyahualica.ddns.net:8080/sistema/venta_boletos/redireccion.php"
  );
